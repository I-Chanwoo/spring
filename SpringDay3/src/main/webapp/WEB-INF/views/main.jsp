	...
	<script type="text/javascript">
		...
		function makeView(data) {
			...
			$.each(data, function(idx, board) {
				...
				//클릭하면 상세내용 보이게
				html += "<td id='t"+board.idx+"'><a href='javascript:goContent("+board.idx+")' class='text-dark'>" + board.title + "</a></td>"
				...
				html += "<br>"
				html += "<button id = 'to"+board.idx+"' onclick = 'goUpdate("+board.idx+")' class='btn btn-outline-secondary'>수정</button>&nbsp;"
				html += "<span><button id = 'up"+board.idx+"' onclick = 'update("+board.idx+")' class='btn btn-outline-secondary' style='display:none'>등록</button></span>&nbsp;"
